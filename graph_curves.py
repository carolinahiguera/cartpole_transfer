...
# gravitys_name = ['9.8*1.5', '9.8*2', '9.8*3', '9.8*4']

gravitys = [9.8, 9.8*4]
masscarts = [3.0, 1.0]
pole_lenghts = [0.5, 0.5]
masspoles = [2.0, 0.1]
...
# for i in range(len(masscarts)):
#     simulations.append(f'masscart{masscarts[i]}_polelenght{pole_lenghts[i]}')
#     names.append(f'masscart={masscarts[i]} - pole lenght={pole_lenghts[i]}')

# for i in range(len(masscarts)):
#     simulations.append(f'masscart{masscarts[i]}_masspoles{masspoles[i]}')
#     names.append(f'masscart={masscarts[i]} - masspole={masspoles[i]}')

# for i in range(len(gravitys)):
#     simulations.append(f'gravity{gravitys[i]}/')
#     names.append(f'gravity={gravitys_name[i]}')

simulations = ['masscart3.0_masspoles2.0', 'gravity39.2', 'T0-T1_2']
names = ['T0: masscart=3.0, masspole=2.0, gravity=9.8','T1:masscart=1.0, masspole=0.1, gravity=9.8*4', 'T0->T1']
